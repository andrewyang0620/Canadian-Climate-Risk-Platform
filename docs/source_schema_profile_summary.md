...
Generated at: `2026-05-09T00:51:26+00:00`
...
|---|---:|---:|---:|---:|---|
| `canadian_disaster_database` | `profiled` | `excel` | `1490` | `25` | `required_fields:False` `location_mapping_contract:True` |
| `vancouver_property_parcels` | `profiled` | `geojson` | `99726` | `6` | `required_fields:True` `identity_contract:True` |
| `vancouver_property_tax` | `profiled` | `csv` | `1552486` | `30` | `required_fields:False` `join_contract:True` |
| `vancouver_building_permits` | `profiled` | `csv` | `50610` | `20` | `required_fields:False` `join_contract:True` |
| `vancouver_floodplain` | `profiled` | `geojson` | `8` | `7` | `required_fields:True` |
| `calgary_property_assessment` | `profiled` | `csv` | `604955` | `22` | `required_fields:False` `coordinate_contract:False` |
| `calgary_flood_hazard` | `profiled` | `geojson` | `1000` | `1` | `required_fields:True` |
| `calgary_building_permits` | `profiled` | `csv` | `490102` | `30` | `required_fields:False` `join_contract:False` |
| `calgary_development_permits` | `profiled` | `csv` | `190399` | `35` | `required_fields:False` `join_contract:True` |
