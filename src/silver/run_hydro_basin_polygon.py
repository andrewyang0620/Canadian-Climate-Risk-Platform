...
from src.silver.hydro_basin_polygon import run_hydro_basin_polygon_silver


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run Silver standardization for Hydro basin polygon source."
    )
...
def main() -> None:
    ...
    run_hydro_basin_polygon_silver(
